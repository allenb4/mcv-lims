                        ...
                        <form action="{{route('admin.settings.reports_submit')}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-3">
                                        <div class="form-group">
                                            <input type="checkbox" name="show_signature" id="show_signature" @if(isset($reports_settings['show_signature']) && $reports_settings['show_signature']) checked @endif>
                                            <label for="show_signature"><i class="fas fa-signature"></i> {{__('Show signature')}}</label>
                                        </div>
                                    </div>
                                    <div class="col-lg-3">
                                      <div class="form-group">
                                          <input type="checkbox" name="show_qrcode" id="show_qrcode" @if(isset($reports_settings['show_qrcode']) && $reports_settings['show_qrcode']) checked @endif>
                                          <label for="show_qrcode"><i class="fas fa-qrcode"></i> {{__('Show QR Code')}}</label>
                                      </div>
                                    </div>
                                    <div class="col-lg-3">
                                      <div class="form-group">
                                          <input type="checkbox" name="show_avatar" id="show_avatar" @if(isset($reports_settings['show_avatar']) && $reports_settings['show_avatar']) checked @endif>
